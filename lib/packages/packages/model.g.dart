...
void _packagesSerialize(
  ...
  writer.writeBool(offsets[2], object.sport);
  writer.writeBool(offsets[3], object.task);
  writer.writeBool(offsets[4], object.timer);
...
Packages _packagesDeserialize(
  ...
  final object = Packages(
    ...
    sport: reader.readBool(offsets[2]),
    task: reader.readBool(offsets[3]),
    timer: reader.readBool(offsets[4]),
...
extension PackagesQueryFilter
  ...
  QueryBuilder<Packages, Packages, QAfterFilterCondition> sportEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'sport',
...
extension PackagesQuerySortBy on QueryBuilder<Packages, Packages, QSortBy> {
  ...
  QueryBuilder<Packages, Packages, QAfterSortBy> sortBySport() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sport', Sort.asc);
    });
  }

  QueryBuilder<Packages, Packages, QAfterSortBy> sortBySportDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PackagesQuerySortThenBy
  ...
  QueryBuilder<Packages, Packages, QAfterSortBy> thenBySport() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sport', Sort.asc);
    });
  }

  QueryBuilder<Packages, Packages, QAfterSortBy> thenBySportDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sport', Sort.desc);
    });
  }
...
extension PackagesQueryWhereDistinct
  ...
  QueryBuilder<Packages, Packages, QDistinct> distinctBySport() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'sport');
    });
  }
...
extension PackagesQueryProperty
  ...
  QueryBuilder<Packages, bool, QQueryOperations> sportProperty() {
    return QueryBuilder.apply(this, (query) {
